...
export default function Navbar() {
  ...
  return (
    <header className="z-30 w-full px-2 py-4 bg-white shadow-sm sm:px-4">
      <div className="flex items-center justify-between mx-auto max-w-7xl">
        <a href="/" title="Kutty Home Page" className="flex items-center">
          ...
          <h1 className="text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-purple-600 to-purple-900 ">
            Perc.
        ...
        <div className="relative hidden space-x-1 md:inline-flex">
          <Link href="/">
            <a className="rounded-full btn btn-sm btn-white">Home</a>
          </Link>
          <Link href="/undangan">
            <a className="rounded-full btn btn-sm btn-white">Undangan</a>
          </Link>
          <Link href="/dokumen">
            <a className="rounded-full btn btn-sm btn-white">Dokumen</a>
          </Link>
          <Link href="/blog">
            <a className="rounded-full btn btn-sm btn-white">Blog</a>
          </Link>
        </div>
        <div className="flex items-center space-x-1">
          <a href="#" className="rounded-full btn btn-sm btn-dark">
            Sign up
          </a>
          <div className="inline-flex md:hidden">
            ...
            <div
              className={`absolute top-0 left-0 right-0 z-50 flex-col ${
                open ? "flex" : "hidden"
              } p-2 m-2 space-y-1 bg-white rounded shadow`}
            >
              <button
                className="self-end flex-none px-2 btn btn-link btn-icon"
                onClick={() => setOpen(!open)}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="grid grid-cols-2 gap-1">
                <a
                  href="#"
                  className="px-3 py-2 transition rounded hover:bg-gray-200 hover:text-primary"
                >
                  Pricing
                </a>
                <a
              ...
              <p className="pt-2 pl-3 text-xs font-semibold tracking-wide text-gray-500 uppercase">
                Features
              </p>
              <div className="grid grid-cols-2 gap-1">
                <a
              ...
              <a
                href="#"
                className="flex items-center justify-center p-3 font-medium transition bg-gray-200 rounded text-primary hover:bg-gray-300"
              >
                View all features
                <svg
                  xmlns="http://www.w3.org/2000/svg"
